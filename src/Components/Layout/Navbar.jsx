                ...
                <div className="flex items-center justify-between h-16">
                    ...
                    <div className="hidden md:block flex-1">
                        <div className="flex items-center justify-center space-x-8">
                            ...
                            <Link to="/services" className="text-gray-950 hover:text-blue-600 px-3 py-2 rounded-md text-sm font-medium transition-colors duration-200">
                                Services
                            </Link>
                            ...
                            <Link to="/pages" className="text-gray-950 hover:text-blue-600 px-3 py-2 rounded-md text-sm font-medium transition-colors duration-200">
                                Pages
                            </Link>
                            <Link to="/news" className="text-gray-950 hover:text-blue-600 px-3 py-2 rounded-md text-sm font-medium transition-colors duration-200">
                                News
                            </Link>
                        </div>
                    </div>
